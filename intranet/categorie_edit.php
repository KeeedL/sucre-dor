...
$resultat = getUnique('categorie','id',$keys[0]);
          ...
          foreach  ($resultat as $menu){
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-lg-offset-0">
                  <form name="form1" action="categorie_filesLogicUpdate.php" method="post" enctype="multipart/form-data" >
                    <fieldset>
                    ...
                    <div class="col-lg-4 col-lg-offset-7">
                      <button type="submit" name="'. $menu['id'] .'" class="btn btn-success">Modifier la categorie</button>
                    </div>
                    </form>
              </div>
          </div>
